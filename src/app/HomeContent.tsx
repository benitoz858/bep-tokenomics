...
export default function HomeContent({ postCount }: { postCount: number }) {
  return (
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "80px 24px" }}>
        ...
        <div style={{ borderTop: "1px solid #1a1a1a", paddingTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: 16 }}>
            <a href="https://bepresearch.substack.com" target="_blank" rel="noopener noreferrer me"
              style={{ fontSize: 11, color: "#666", textDecoration: "none", fontFamily: "'JetBrains Mono', monospace" }}>
              Substack
            </a>
            <a href="https://x.com/benitoz" target="_blank" rel="noopener noreferrer me"
              style={{ fontSize: 11, color: "#666", textDecoration: "none", fontFamily: "'JetBrains Mono', monospace" }}>
              X
            </a>
            <a href="https://www.linkedin.com/in/benpouladian" target="_blank" rel="noopener noreferrer me"
              style={{ fontSize: 11, color: "#666", textDecoration: "none", fontFamily: "'JetBrains Mono', monospace" }}>
              LinkedIn
            </a>
            <a href="https://www.youtube.com/@bepresearch" target="_blank" rel="noopener noreferrer me"
              style={{ fontSize: 11, color: "#666", textDecoration: "none", fontFamily: "'JetBrains Mono', monospace" }}>
              YouTube
            </a>
          </div>
